...
internal object JecnaPeriodEncoder
{
    ...
    /**
     * @param periodOption The [io.github.tomhula.jecnaapi.data.timetable.TimetablePage.PeriodOption] to encode.
    ...
    /**
     * @receiver The [io.github.tomhula.jecnaapi.data.timetable.TimetablePage.PeriodOption] to encode.
     * @return Timetable period URL query parameter as [Pair] of a key and a value.
     */
