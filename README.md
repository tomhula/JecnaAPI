...
```kotlin
dependencies {
    implementation("io.github.tomhula:jecnaapi-core:10.3.0")
    /* API na www.spsejecna.cz */
    implementation("io.github.tomhula:jecnaapi-jecna:10.3.0")
    /* API na www.spsejecna.cz pro Javu */
    implementation("io.github.tomhula:jecnaapi-jecna-java:10.3.0")
    /* API na jidelnu */
    implementation("io.github.tomhula:jecnaapi-canteen:10.3.0")
